  ...
  <section class="content">
            ...
            <div class="col-md-12">
              <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h4><i class="icon fa fa-check"></i> Erro ao excluir curso!</h4>
              </div>
              <!-- end alert -->
            </div>
            <!-- end col -->
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h4><i class="icon fa fa-check"></i> Curso excluído com sucesso!</h4>
              </div>
              <!-- end alert -->
            </div>
            <!-- end col -->
    ...
    @if((old('titulo')) && (count($errors) <= 0))
       <div class="alert alert-success">
          <i class="fa fa-check"></i> <b>Curso {{ old('titulo') }}</b> foi cadastrado com sucesso!
      ...
      <div class="col-md-12">
        <div class="box box-primary" style="background-color: #f2f2f2;">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-list-ol"></i> Cursos cadastrados
                <small>pesquisa por: título ou descrição </small>
              </h3>
            </div>
            <!-- /.box-header -->
              <div class="box-body">
                      ...
                      <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead>
                          <tr role="row" style="background-color: #222d32;">
                            <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 296.71875px; color: #f2f2f2;">Codigo do curso
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 361.03125px; color: #f2f2f2;">Título
                            </th>
                        ...
                        <tbody>
                          @foreach ($cursos as $c)
                            <tr role="row" class="odd">
                              <td class="sorting_1"><span class="label label-info" style="font-size: 15px;">{{ $c->id_curso }}</span></td>
                              <td>{{ $c->titulo }}</td>
                              <td>{{ $c->descricao }}</td>
                              <td class="text-center">
                                <span class="label label-primary" style="font-size: 15px;">
                                  <a href="/cursos/editar/{{ $c->id_curso }}">
                              ...
                              <td class="text-center">
                                <span class="label label-danger" style="font-size: 15px;">
                                  <a href="#" data-toggle="modal" id="{{ $c->id_curso }}" onclick="idModal(this.id)">
        ...
        <div class="row">
          <div class="col-md-12">
            <button class="btn btn-success form-control" data-toggle="modal" data-target="#myModal2">Cadastrar novo curso</button>
          </div>
        </div>
      </div>
      </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: #f2f2f2;">
          <div class="modal-header" style="background-color: #f2f2f2;">
            ...
            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-book"></i> Cadastrar novo curso</h4>
          </div>
          <form action="/cursos/cadastrar" method="post">
            <div class="modal-body">
                <div class="box box-primary" style="background-color: #f2f2f2;">
                    <div class="box-header with-border">
                        <h1 class="box-title">Curso <small>informações</small></h1>
                        <div class="box-body">
                            <div class="row">
  ...
  <script>
    function idModal(id){
      var html = '<span class="label label-info" style="font-size: 16px;">'+ id +'</span>';
       $('.box-title').text('Deseja excluir curso de código: ');
       $('.box-title').append(html);
       $('#excluirProp').attr("href", "/cursos/excluir/"+id);
       $('#myModal').modal('show');
    }
  </script>
